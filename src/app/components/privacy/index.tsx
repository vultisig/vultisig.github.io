...
In the future, we may also collect, store, and use certain personal data that you voluntarily provide to us or as required by law. This may include your email address, feedback information, and other personal data you may voluntarily provide, such as your name, address, and other contact details.
            ...
            <li>Provision, execution and administration (including support) of Services</li>
            <li>Marketing, improvement and maintenance of Services as well as services and product
            development</li>
            <li>Security and prevention</li>
            <li>Compliance with statutory and regulatory requirements</li>
            <li>Protection of rights</li>
            </ul> 
            </div>
            <div className="text-decoration-underline py-2"> 6- LEGAL BASIS FOR PROCESSING AND DISCLOSURE OF YOUR PERSONAL DATA	</div>
            
            <div className="py-2"> 
                <ul style={{listStyle:"none"}}>
                    <li>
            6.1 Lawful basis for processing your personal data
                We will only use your personal data when the law allows us to. Most commonly we will use your personal data in the following circumstances:
                <ul>
            <li>Where you have asked us to do so, or consented to us doing so;</li>
            <li>Where it is necessary for the performance of a Service or in order to take steps at your request
            prior to providing the Services;</li>
            ...
            To unsubscribe from marketing emails at any time and without cost, please click on the unsubscribe link at the bottom of any marketing email. You may also contact us (info@vultisig.com) to inform us if you do not wish to receive any marketing materials from us.
            <br/>
            <br/>
            </li>
            <li>
...
<p>
            If we collect personal data in the future, we may share it in the following ways:		</p>
            <ul>		
            <li>with any member of our group, which means our subsidiaries, our ultimate holding company and its subsidiaries;</li>
            <li>with selected third parties including business partners, suppliers and sub-contractors for the performance of any contract we enter into with them (see “Service Providers” below); or</li>
            <li>with analytics that assist us in the improvement and optimisation of the Services.					</li>
            </ul>
            <br/>
            <p>
           ...
           These third parties shall act as separate and independent controllers of that personal data and shall process it in accordance with their own privacy policy.					
            ...
            <div className="text-decoration-underline py-2"> 7- Security					</div>
            <div className="py-2"> 
                <p>
            ...
            <div className="text-decoration-underline py-2"> 8- International Data Transfers					</div>
            <div className="py-2"> 
                <p>
            ...
            <ul>
            <li>Ensuring the recipient is located in a country that has laws substantially similar to the APPs, providing an adequate level of protection for your personal information.</li>
            <li>Entering into a contract with the recipient that requires them to handle your personal information in a manner consistent with the APPs.</li>
            <li>Obtaining your consent to the disclosure, after informing you that the overseas recipient may not be required to comply with the APPs and you may not be able to seek redress under the Privacy Act.</li>
            </ul>
            <p>
            ...
            <div className="text-decoration-underline py-2"> 9- Your Rights				</div>
            <div className="py-2"> 
                <p>As a data subject you have a number of rights in relation to your personal data. Below, we have described the various rights that you have as well as how you can exercise them (provided that the applicable conditions are met and subject applicable statutory exceptions).				
                </p>
            <ul style={{listStyle:"none"}}>    
                <li>           
            9.1 Right of Access			
            ...
            <li>
            9.6 Your Right to stop receiving marketing communications					
            <p>
            ...
            <p>
            9.6.1 8.7 Your Right to object to automated Decision Making and Profiling
...
We currently use offers from the following service providers and advertising partners (where they use data from you or cookies set on your computer for advertising purposes):					
            ...
            <div className="text-decoration-underline py-2"> 12- HOW WE MAY CHANGE THIS PRIVACY POLICY?	</div>
            <div className="py-2"> Vultisig, in its sole discretion, may modify or update this policy at any time, especially if we change our data processing activities or if new legal provisions become applicable, so you should review this page periodically. The version published on the website is the current version. </div>
            <br/><br/><br/>
        </>
    )
}