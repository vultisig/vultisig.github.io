...
export function Sections() {
    ...
    return (
        <>
          <h1 className="monserrat-bold text-center my-5">Terms of Service </h1>
          <div  className="text-center" style={{fontSize:"1rem"}}>Last modified: August 2024 </div>
          <p>
          THESE TERMS CONSTITUTE A LEGALLY BINDING AGREEMENT BETWEEN YOU AND US. PLEASE READ THESE TERMS CAREFULLY TO ENSURE THAT YOU UNDERSTAND AND AGREE TO EVERY PORTION OF THESE TERMS BEFORE USING ANY PART OF THE SERVICE. Vultisig PROVIDES SOFTWARE TO INTERACT WITH MULTIPLE BLOCKCHAINS, INCLUDING BUT NOT LIMITED TO THORCHAIN, ETHEREUM, BINANCE SMART CHAIN, AND SOLANA. THESE BLOCKCHAINS ARE OPERATED BY THIRD PARTIES.
          </p>
          <p>
          ...
          <ol type="i">
            ...
            Use of the Service  
                <ol type="a">
                    ...
                    <li>
                    The Service Generally. Generally, the purpose of the Service is to allow Users to hold and interact with various blockchains, including but not limited to THORChain, for activities such as buying, selling, or otherwise transferring digital assets (referred to as a “Transaction”). OUR SERVICE IS NON-CUSTODIAL AND BASED ON THIRD-PARTY BLOCKCHAINS, MEANING Vultisig NEVER TAKES CONTROL OF THE DIGITAL ASSETS THAT INTERACT WITH OUR SERVICE OR OF THE BLOCKCHAINS GOVERNING THE TRANSACTION. THE TRANSACTION IS BETWEEN YOU AND THE RESPECTIVE BLOCKCHAIN AND GOVERNED BY THE TERMS OF THAT BLOCKCHAIN. You may be charged a miner or network fee by the respective blockchain to process the Transaction on your behalf (a “Miner Fee”). The Miner Fee applicable to your Transaction is shown to you before your authorization of the Transaction. Vultisig may modify or update any portion of the Service at any time. Subject to your full compliance with these Terms, you are hereby granted a non-exclusive, limited, non-transferable, freely revocable license to access and use the Service for entrepreneurial or business use only (as opposed to a use for personal, social, family, household, and similar needs) and as permitted by the features of the Service, at and during the time of your access or use of the Service (“Service License”). You shall not use any part of the Service for illegal or fraudulent purposes or for the purpose of consummating Transactions on behalf of another person. For the avoidance of doubt, you must be the beneficial owner of the digital assets, the sending address, and the destination address. Vultisig reserves all rights not expressly granted in these Terms in the Service and the Vultisig Content (as defined below). Vultisig may revoke the Service License or any portion of the Service at any time for any or no reason. For the avoidance of doubt, you may stop using our Services at any time for any or no reason.
                    </li>
                    <li>
                     Suspension or Termination of the Service. You acknowledge that we may, without prior notice to you: suspend the Service; change the Service; stop providing the Service or features of the Service, to you or to Users generally; or create usage or Transaction limits on the Service. In particular, we may suspend, change or stop providing the Service in response to changed regulatory requirements or in case you used the Service in reasonably suspected or actual violation of these Terms. For the avoidance of doubt, you may stop using our Services at any time for any or no reason. 
                     <br></br><br></br>
                    </li>
                    <li>
                    Third-Party Integrations. You acknowledge that the Service is based on third-party smart contract platforms, including but not limited to THORChain, 1inch, and Li.Fi, operated according to their respective terms (see: www.thorchain.com, www.1inch.io, https://li.fi/) and may contain links or integrations to third-party (i.e., not Vultisig or any of our affiliates) materials, services, or software that are not owned, controlled, and/or offered by us but by third parties, including, in particular, smart contracts (each, a “Third-Party Service”). WE DO NOT OFFER, ENDORSE, OR ASSUME ANY RESPONSIBILITY FOR ANY THIRD-PARTY SERVICE. IF YOU ACCESS AND/OR USE A THIRD-PARTY SERVICE FROM THE SERVICES OR SHARE ANY CONTENT ON OR THROUGH SUCH THIRD-PARTY SERVICE, YOU ACKNOWLEDGE THAT: YOU DO SO AT YOUR OWN RISK; THESE TERMS AND OUR PRIVACY POLICY DO NOT APPLY TO SUCH THIRD-PARTY SERVICE; YOU MAY BE REQUIRED BY SUCH THIRD-PARTY TO AGREE TO CERTAIN ADDITIONAL TERMS OR CREATE AN ACCOUNT; AND THAT CERTAIN THIRD-PARTY SERVICES MAY PUBLISH TO A PUBLIC BLOCKCHAIN INFORMATION YOU SEND TO SUCH THIRD-PARTY. You shall not hold us liable for any damages you incur related to your use of any Third-Party Service.
                    <br></br><br></br>
                    </li>
                    <li>
                    DEX Trading. Through our App, we offer the ability to connect to various blockchains, including but not limited to THORChain, 1inch, and Li.Fi (see: www.thorchain.com, www.1inch.io, www.li.fi), that allow you to trade digital assets in a decentralized way. You expressly acknowledge that we do not control or maintain the blockchains you may connect with through our App, nor are we a party to any Transaction on these blockchains through our Service. You further acknowledge that we will have no liability for any interaction you have with these blockchains. Further, you also acknowledge that we cannot reverse or refund any transaction that occurs on these blockchains. You acknowledge that prior to completing a trade on any blockchain, you have the sole responsibility to conduct diligence on the blockchain, the assets being traded, and the underlying smart contract(s) of the respective blockchain.
                    <br></br><br></br>
                    </li>
                    <li>
                        <p>
                     Liquidity Rewards. Through the App, you may deposit a pair of certain digital assets into a liquidity pool entirely provided and facilitated by THORChain and MAYA Protocol, enabling you to possibly earn returns on those digital assets from these platforms (“Liquidity Mining”). When used in connection with Liquidity Mining, “APR” means: the estimated annual percentage return provided by THORChain or MAYA Protocol for a certain pair of digital assets, calculated by the respective platform based on the prior 24 hours of accrued liquidity fees divided by total liquidity for that pair of digital assets.
                    </p>
                    <p>
                    APR is based entirely on publicly available data provided by THORChain or MAYA Protocol. You acknowledge that the APR figures provided by THORChain shown in the App is for illustration purposes only and is not a guarantee that any such returns will materialize. You further acknowledge that we will not be liable to you for any reliance on any APR shown in the App. 
                    </p>
                    <p>
...
taxes associated with your Transactions. 
<br/><br/>
                            </li>
                        </ol>
                    ...
                    User Feedback and Ideas 
                        ...
                        <ol type="a">
                            <li>
                            User Feedback and Ideas. You may choose to or we may invite you to submit feedback, ideas, modifications, comments, or suggestions about the Service or Vultisig generally, including about how to improve the Service or our products (each, an “Idea”). By submitting any Idea, you acknowledge that and hereby consent to your disclosure being gratuitous, unsolicited and without restriction and will not place Vultisig under any fiduciary or other obligation, and that Vultisig is the sole owner of such Idea and that we are free to use any Idea without any additional compensation to you, or to disclose the Ideas on a non-confidential basis or otherwise to anyone. You acknowledge that, despite our acceptance of your Idea submission, Vultisig does not waive any rights to use similar or related ideas previously known to Vultisig, or developed by its employees or contractors, or obtained from sources other than you. 
                            </li>
                        </ol>
...
in or out of Vultisig’s system. You acknowledge that Vultisig will comply willingly with all valid legal requests for information. We reserve the right to provide information to law enforcement personnel and other third-parties to answer inquiries, participate in investigations, respond to legal process, respond to the order of a court of competent jurisdiction and those exercising the court’s authority, and to protect Vultisig and our Users. 
                    ...
                    <ol type="a">
                        <li>
                        No Refunds. You acknowledge that Vultisig does not and cannot issue refunds in connection with any Transaction initiated or completed on THORChain. 
                        </li>
                        <li>
                        ...
                        <li>
                            <p>
                        Cross-Chain Recovery Program. Please use extreme caution when sending digital assets to Vultisig or the Service and make sure to confirm that you are sending the correct type of digital asset to the correct address. A transfer of digital assets to Vultisig that is mistakenly sent to an address of a different digital asset is a “Cross 
Chain Transaction”. Recovery of Cross-Chain Transactions is a risky and time-consuming process. The level of complexity and risk depends both on the type of digital asset and the address used for the Transaction. Not all Cross-Chain Transactions are recoverable, and digital assets sent to the wrong address are at risk of recovery by bad actors not associated with Vultisig. 
</p>
<p>
...
related to: (i) any hacking, tampering, or other unauthorized access or use of the Service, or the personal information; (ii) errors, mistakes, or inaccuracies of content on the Service; (iii) property damage, of any nature, resulting from your access to or use of the Service; (iv) any interruption or cessation of transmission to or from the Service; (v) any bugs, viruses, trojan horses, or the like that may be transmitted to or through the Service by any third-party; or (vi) the defamatory, offensive, or illegal conduct of any third-party. The foregoing limitations and exclusions will apply whether the alleged or actual liability is based on contract, tort, negligence, strict liability, or any other basis, even if Vultisig has been advised of the possibility of such damage.
                        ...
                        <li>
                            <p>
                            Governing Law. These Terms will be governed by the internal substantive laws of Australia without respect to its conflict of laws principles. The application of the United Nations Convention on Contracts for the International Sale of Goods is expressly excluded. 
                            </p>
                            <p>
                        ...
                        <li>
                            <p>
                            Place of jurisdiction. If the choice of arbitration is set forth in lit. e. above is not valid, and/or prohibited or otherwise invalid or unenforceable under applicable law, then the following applies:
                            </p>
                            <p>
                        ...
                        <li>
                        Injunctive Measures. Regardless of lit. d., e. and f above, we retain the right to seek injunctive or other equitable relief in a court of competent jurisdiction to prevent the actual or threatened infringement, misappropriation, or violation of a our copyrights, trademarks, trade secrets, patents, or other Intellectual Property Rights, including any provisional relief required to prevent irreparable harm. 
                        </li>
                        <li>
                        Assignment. You shall not assign or transfer these Terms or any rights and licenses granted under these Terms. Any attempted assignment or transfer in violation of this section will be void and of no legal effect. 
                        </li>
                        <li>
                        ...
                        <li>
                        Entire Agreement/Severability. These Terms, together with any additional terms, amendments, and any additional agreements you may enter into with Vultisig in connection with the Service, constitute the entire agreement between you and Vultisig concerning the Service. If any portion of these Terms is deemed invalid by a court of competent jurisdiction, the invalidity of such portion will not affect the validity of the remaining provisions of these Terms, which will remain in full force and effect. 
                        </li>
                        <li>
                        No Waiver. No waiver of any term of these Terms will be deemed a further or continuing waiver of such term or any other term, and Vultisig’s failure to assert any right or provision under these Terms will not constitute a waiver of such right or provision. 
                        </li>
                        <li>
                        Contact. If you have any questions regarding these Terms, you may contact us at: info@vultisig.com, Cortina Ventures Pty Ltd, 46 Singlefin Crescent, Bokarina, Queensland, Australia 4575.
