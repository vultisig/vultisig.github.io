...
export const homeCopy = {
  ...
  segment1: {
    subTitle: "WHAT IS<span class='gradient-text '> WRONG</span> WITH WALLETS",
    items: [
      {
  ...
  segment3: {
    mainTitle:
      "<span class='gradient-text'>SEAMLESS SECURITY </span><br/> WITHOUT COMPROMISE ON <br/> EXPERIENCE ",
    items: [
      {
  ...
  segment4: {
    mainTitle: "BEST FEATURES IN <span class='gradient-text'>ONE PLACE</span> ",
    itemOne: {
    ...
    items: [
      {
        ...
        description:
          "Swap, borrow, save or spend in one wallet. You never need a second wallet again. Interact with the FIAT world in a safe way with the optional free Swiss bank account. ",
        image: "./img/btc.svg",
        alt: "",
      },
      {
